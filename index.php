...
<body>
	...
	<main>
		...
		<table>
			...
			<tbody>
				<?php
					include('./assets/utils/my_classes.php');
	...
	<div class="modal">
		<div class='wrapper'>
			...
			<form action="assets/utils/send.php" method="POST">
					<h3>Veículo</h3>
					<div class="camp">
	...
	<script src="/assets/utils/data.js"></script>
	<script src="/assets/utils/main.js"></script>
</body>
</html>